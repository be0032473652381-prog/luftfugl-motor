...
#define DEBUG_ADC_TRACE_DEPTH 256u
...
#define DBG_MAGIC_FULL_PENDING 0x4C554633u
#define DBG_MAGIC_PLAIN_PENDING 0x4C554634u
#define DEBUG_PERSIST_CONFIRM_MS 2000u
#endif
