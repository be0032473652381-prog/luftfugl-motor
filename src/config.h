...
#define EVENT_TIMER_INTERVAL_MINUTES 3u
#define EVENT_TIMER_ALERT_COUNT 5u
#define EVENT_TIMER_ALERT_ON_MS 200u
#define EVENT_TIMER_ALERT_OFF_MS 200u
#define EVENT_TIMER_BUZZER_HZ 1000u
...
#define DEBUG_PAGE6_DS3231_TIMER_ROW 29u
