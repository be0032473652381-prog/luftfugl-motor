...
#define I2C_TRANSACTION_TIMEOUT_US 5000u
#define I2C_RECOVERY_CLOCK_PULSES 9u
#define I2C_RECOVERY_HALF_PERIOD_US (500000u / I2C_BAUD)
#define SCD41_ADDRESS 0x62u
#define DS3231_ADDRESS 0x68u
#define DS3231_TEMP_MSB_REGISTER 0x11u
#define DS3231_TEMP_QUARTER_CENTIDEGREES 25
#define PIN_DS3231_INT 17
#define PIN_ONBOARD_LED 25
#define EVENT_TIMER_INTERVAL_DEFAULT_SECONDS 180u
#define EVENT_TIMER_INTERVAL_MIN_SECONDS 15u
#define EVENT_TIMER_INTERVAL_MAX_SECONDS 18000u
#define EVENT_TIMER_LED_ON_MS 5000u
...
#define LED_BATTERY_WARNING_BRIGHTNESS_PERCENT 30u
#define LED_BATTERY_CRITICAL_BRIGHTNESS_PERCENT 30u
#define LED_BATTERY_WARNING_PERIOD_MS 15000u
#define LED_BATTERY_WARNING_FLASH_MS 150u
#define LED_BATTERY_WARNING_GAP_MS 150u
...
#define DEBUG_SCREEN_BOTTOM_ROW 100u
#define DEBUG_HELP_WRAP_COLUMNS 78u
